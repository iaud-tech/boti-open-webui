...
class ChannelTable:
    def _get_access_grants(self, channel_id: str, db: Session | None = None) -> list[AccessGrantModel]:
    ...
    def insert_new_channel(
        self, form_data: CreateChannelForm, user_id: str, db: Session | None = None
    ) -> ChannelModel | None:
    ...
    def get_channels(self, db: Session | None = None) -> list[ChannelModel]:
        with get_db_context(db) as db:
    ...
    def get_channels_by_user_id(self, user_id: str, db: Session | None = None) -> list[ChannelModel]:
        with get_db_context(db) as db:
    ...
    def get_dm_channel_by_user_ids(self, user_ids: list[str], db: Session | None = None) -> ChannelModel | None:
        with get_db_context(db) as db:
    ...
    def is_user_channel_manager(self, channel_id: str, user_id: str, db: Session | None = None) -> bool:
        with get_db_context(db) as db:
    ...
    def join_channel(self, channel_id: str, user_id: str, db: Session | None = None) -> ChannelMemberModel | None:
        with get_db_context(db) as db:
    ...
    def leave_channel(self, channel_id: str, user_id: str, db: Session | None = None) -> bool:
        with get_db_context(db) as db:
            membership = (
                db.query(ChannelMember)
                .filter(
    ...
    def get_member_by_channel_and_user_id(
        self, channel_id: str, user_id: str, db: Session | None = None
    ...
    def get_members_by_channel_id(self, channel_id: str, db: Session | None = None) -> list[ChannelMemberModel]:
        with get_db_context(db) as db:
    ...
    def update_member_last_read_at(self, channel_id: str, user_id: str, db: Session | None = None) -> bool:
        with get_db_context(db) as db:
            membership = (
                db.query(ChannelMember)
                .filter(
    ...
    def is_user_channel_member(self, channel_id: str, user_id: str, db: Session | None = None) -> bool:
        with get_db_context(db) as db:
            membership = (
                db.query(ChannelMember)
                .filter(
    ...
    def get_channel_by_id(self, id: str, db: Session | None = None) -> ChannelModel | None:
        try:
            with get_db_context(db) as db:
    ...
    def get_channels_by_file_id(self, file_id: str, db: Session | None = None) -> list[ChannelModel]:
        with get_db_context(db) as db:
    ...
    def get_channels_by_file_id_and_user_id(
        self, file_id: str, user_id: str, db: Session | None = None
    ) -> list[ChannelModel]:
        with get_db_context(db) as db:
    ...
    def get_channel_by_id_and_user_id(self, id: str, user_id: str, db: Session | None = None) -> ChannelModel | None:
        with get_db_context(db) as db:
            # Fetch the channel
            channel: Channel = (
                db.query(Channel)
    ...
    def update_channel_by_id(self, id: str, form_data: ChannelForm, db: Session | None = None) -> ChannelModel | None:
        with get_db_context(db) as db:
            channel = db.query(Channel).filter(Channel.id == id).first()
            if not channel:
                return None
    ...
    def add_file_to_channel_by_id(
        self, channel_id: str, file_id: str, user_id: str, db: Session | None = None
    ...
    def remove_file_from_channel_by_id(self, channel_id: str, file_id: str, db: Session | None = None) -> bool:
        try:
            with get_db_context(db) as db:
    ...
    def delete_channel_by_id(self, id: str, db: Session | None = None) -> bool:
        with get_db_context(db) as db:
    ...
    def get_webhooks_by_channel_id(self, channel_id: str, db: Session | None = None) -> list[ChannelWebhookModel]:
        with get_db_context(db) as db:
    ...
    def get_webhook_by_id(self, webhook_id: str, db: Session | None = None) -> ChannelWebhookModel | None:
        with get_db_context(db) as db:
    ...
    def get_webhook_by_id_and_token(
        self, webhook_id: str, token: str, db: Session | None = None
    ) -> ChannelWebhookModel | None:
        with get_db_context(db) as db:
            webhook = (
    ...
    def update_webhook_last_used_at(self, webhook_id: str, db: Session | None = None) -> bool:
        with get_db_context(db) as db:
            webhook = db.query(ChannelWebhook).filter(ChannelWebhook.id == webhook_id).first()
            if not webhook:
                return False
    ...
    def delete_webhook_by_id(self, webhook_id: str, db: Session | None = None) -> bool:
        with get_db_context(db) as db:
